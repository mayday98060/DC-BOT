...
async def 幫助(interaction: discord.Interaction):
    ...
    幫助.add_field(name="🏆排行榜🏆", value="排行榜列表", inline=True)
    ...
    async def 播放(self,interaction: discord.Interaction):
        ...
        class SongSelectView(View):
            ...
            def update_select_menu(self):
                ...
                if pages > 1:
                    prev_button = discord.ui.Button(label="上一頁", style=discord.ButtonStyle.primary)
                    prev_button.callback = self.previous_page
                    next_button = discord.ui.Button(label="下一頁", style=discord.ButtonStyle.primary)
